    ...
    <div id="container">
        <div id="sidebar">
           <!-- <span><?=$_SESSION["acc_type"]?></span>-->
            ...
            <nav>
                <ul>
                    <!--<li ><button class="nav_btn"  data-target="http://localhost/cms/admin/dashboard"><i class="icofont-dashboard-web"></i></button></li>-->
                    <li class="active_btn" ><button class="nav_btn" alt="complaints" data-target="http://localhost/cms/admin/complaint"><i class="icofont-files-stack"></i></button></li>
                    <li><button  class="nav_btn"  data-target="http://localhost/cms/admin/chat"><i class="icofont-chat"></i> <span id="chat_signal_btn" class=<?=(\app\App::get_message()->available_unread()!=true)? "":"show_signal"?>></span></button></li>
                    <li><button class="nav_btn"  data-target="http://localhost/cms/admin/notification"><i class="icofont-notification"></i><span id="notifictaion_count"></span></button></li>
                    <li><button class="nav_btn"  data-target="http://localhost/cms/admin/history"><i class="icofont-history"></i></button></li>
                    <li><button class="nav_btn"  data-target="http://localhost/cms/admin/settings"><i class="icofont-settings-alt"></i></button> </li>
                </ul>
            </nav>
        </div>
...
<script src="http://localhost/cms/assets/js/referal.js"></script>
<script>
  document.addEventListener("DOMContentLoaded",function(){
    ...
    conn.onopen = function(e) {
        ...
        conn.send(JSON.stringify({type:"user_status",id:$("#user_id").value,status:1}));
    };
